...
# Title: Normal FM Receiver
# Author: Scott Fraser
# Generated: Thu Jun 22 23:07:23 2017
##################################################
...
class Normal_FM_Receiver(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Normal FM Receiver")
        ...
        self.connect((self.osmosdr_source_0, 0), (self.source_waterfall, 0))    
...
def main(top_block_cls=Normal_FM_Receiver, options=None):
